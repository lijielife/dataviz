...
reader = csv.reader(open('/Users/swetharevanur/Documents/dataviz/chloropleth/unemployment-aug2010.txt', 'r'), delimiter=",")

# Load the SVG map
svg = open('/Users/swetharevanur/Documents/dataviz/chloropleth/counties.svg', 'r').read()
...
for row in reader:
    ...
    try:
        if row[1] % 1000 == 0:
            ...
            code03 = float(row[3].strip())
            #code13 = float(row[4].strip())
            code_2003[row[1]] = code03
            #code_2013[row[1]] = code13
    except:
        pass
